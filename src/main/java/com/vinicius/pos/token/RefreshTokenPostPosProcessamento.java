package com.vinicius.pos.token;
...
@ControllerAdvice
public class RefreshTokenPostPosProcessamento 
	...
	public boolean supports(
		...
		return returnType.getMethod()
				.getName().equals("postAccessToken");
	}
	...
	private void excluirRefreshTokenDaResposta(DefaultOAuth2AccessToken token) {token.setRefreshToken(null);}
