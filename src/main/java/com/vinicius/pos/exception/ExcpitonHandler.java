package com.vinicius.pos.exception;
...
@ControllerAdvice
public class ExcpitonHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleEmptyResultDataAccess(
		...
		return super.handleExceptionInternal(ex, new DetalheErro("Recurso não encontrado",
	...
	private List<DetalheErro> criarListaDeErro(BindingResult bindingResult) {
		...
		.getAllErrors()
		.forEach(f -> 
		erros.add(new DetalheErro(
				f.getDefaultMessage(), f.toString())));
